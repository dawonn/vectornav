...
struct BinaryOutputRegister
{
  ...
  INSGROUP insField;            ///< Group 6 (INS)
	...
	BinaryOutputRegister() :
		asyncMode(ASYNCMODE_NONE),
		rateDivisor(0),
		commonField(COMMONGROUP_NONE),
		timeField(TIMEGROUP_NONE),
		imuField(IMUGROUP_NONE),
		gpsField(GPSGROUP_NONE),
		attitudeField(ATTITUDEGROUP_NONE),
		insField(INSGROUP_NONE)
	{ }
	...
	BinaryOutputRegister(
		...
		COMMONGROUP commonFieldIn,
		TIMEGROUP timeFieldIn,
		IMUGROUP imuFieldIn,
		GPSGROUP gpsFieldIn,
		ATTITUDEGROUP attitudeFieldIn,
		INSGROUP insFieldIn) :
		asyncMode(asyncModeIn),
	...
	BinaryOutputRegister(
		...
		uint16_t insFieldIn) :
		asyncMode(static_cast<ASYNCMODE>(asyncModeIn)),
		rateDivisor(rateDivisorIn),
		commonField(static_cast<COMMONGROUP>(commonFieldIn)),
		timeField(static_cast<TIMEGROUP>(timeFieldIn)),
		imuField(static_cast<IMUGROUP>(imuFieldIn)),
		gpsField(static_cast<GPSGROUP>(gpsFieldIn)),
		attitudeField(static_cast<ATTITUDEGROUP>(attitudeFieldIn)),
		insField(static_cast<INSGROUP>(insFieldIn))
	{ }
};
...
/// \brief Converts a QuaternionMagneticAccelerationAndAngularRatesRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const QuaternionMagneticAccelerationAndAngularRatesRegister &reg);

/// \brief Converts a MagneticAccelerationAndAngularRatesRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const MagneticAccelerationAndAngularRatesRegister &reg);

/// \brief Converts a MagneticAndGravityReferenceVectorsRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const MagneticAndGravityReferenceVectorsRegister &reg);

/// \brief Converts a FilterMeasurementsVarianceParametersRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const FilterMeasurementsVarianceParametersRegister &reg);

/// \brief Converts a MagnetometerCompensationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const MagnetometerCompensationRegister &reg);

/// \brief Converts a FilterActiveTuningParametersRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const FilterActiveTuningParametersRegister &reg);

/// \brief Converts a AccelerationCompensationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const AccelerationCompensationRegister &reg);

/// \brief Converts a YawPitchRollMagneticAccelerationAndAngularRatesRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const YawPitchRollMagneticAccelerationAndAngularRatesRegister &reg);

/// \brief Converts a CommunicationProtocolControlRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const CommunicationProtocolControlRegister &reg);

/// \brief Converts a SynchronizationControlRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const SynchronizationControlRegister &reg);

/// \brief Converts a SynchronizationStatusRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const SynchronizationStatusRegister &reg);

/// \brief Converts a FilterBasicControlRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const FilterBasicControlRegister &reg);

/// \brief Converts a VpeBasicControlRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const VpeBasicControlRegister &reg);

/// \brief Converts a VpeMagnetometerBasicTuningRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const VpeMagnetometerBasicTuningRegister &reg);

/// \brief Converts a VpeMagnetometerAdvancedTuningRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const VpeMagnetometerAdvancedTuningRegister &reg);

/// \brief Converts a VpeAccelerometerBasicTuningRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const VpeAccelerometerBasicTuningRegister &reg);

/// \brief Converts a VpeAccelerometerAdvancedTuningRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const VpeAccelerometerAdvancedTuningRegister &reg);

/// \brief Converts a VpeGyroBasicTuningRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const VpeGyroBasicTuningRegister &reg);

/// \brief Converts a MagnetometerCalibrationControlRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const MagnetometerCalibrationControlRegister &reg);

/// \brief Converts a CalculatedMagnetometerCalibrationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const CalculatedMagnetometerCalibrationRegister &reg);

/// \brief Converts a VelocityCompensationControlRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const VelocityCompensationControlRegister &reg);

/// \brief Converts a VelocityCompensationStatusRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const VelocityCompensationStatusRegister &reg);

/// \brief Converts a ImuMeasurementsRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const ImuMeasurementsRegister &reg);

/// \brief Converts a GpsConfigurationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const GpsConfigurationRegister &reg);

/// \brief Converts a GpsSolutionLlaRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const GpsSolutionLlaRegister &reg);

/// \brief Converts a GpsSolutionEcefRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const GpsSolutionEcefRegister &reg);

/// \brief Converts a InsSolutionLlaRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const InsSolutionLlaRegister &reg);

/// \brief Converts a InsSolutionEcefRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const InsSolutionEcefRegister &reg);

/// \brief Converts a InsBasicConfigurationRegisterVn200 into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const InsBasicConfigurationRegisterVn200 &reg);

/// \brief Converts a InsBasicConfigurationRegisterVn300 into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const InsBasicConfigurationRegisterVn300 &reg);

/// \brief Converts a InsAdvancedConfigurationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const InsAdvancedConfigurationRegister &reg);

/// \brief Converts a InsStateLlaRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const InsStateLlaRegister &reg);

/// \brief Converts a InsStateEcefRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const InsStateEcefRegister &reg);

/// \brief Converts a StartupFilterBiasEstimateRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const StartupFilterBiasEstimateRegister &reg);

/// \brief Converts a DeltaThetaAndDeltaVelocityRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const DeltaThetaAndDeltaVelocityRegister &reg);

/// \brief Converts a DeltaThetaAndDeltaVelocityConfigurationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const DeltaThetaAndDeltaVelocityConfigurationRegister &reg);

/// \brief Converts a ReferenceVectorConfigurationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const ReferenceVectorConfigurationRegister &reg);

/// \brief Converts a GyroCompensationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const GyroCompensationRegister &reg);

/// \brief Converts a ImuFilteringConfigurationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const ImuFilteringConfigurationRegister &reg);

/// \brief Converts a GpsCompassBaselineRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const GpsCompassBaselineRegister &reg);

/// \brief Converts a GpsCompassEstimatedBaselineRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const GpsCompassEstimatedBaselineRegister &reg);

/// \brief Converts a ImuRateConfigurationRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const ImuRateConfigurationRegister &reg);

/// \brief Converts a YawPitchRollTrueBodyAccelerationAndAngularRatesRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const YawPitchRollTrueBodyAccelerationAndAngularRatesRegister &reg);

/// \brief Converts a YawPitchRollTrueInertialAccelerationAndAngularRatesRegister into a string.
/// \param[in] reg The register to convert to string.
/// \return The string representation.
std::string str(const YawPitchRollTrueInertialAccelerationAndAngularRatesRegister &reg);

}
/// \brief Parses a string that represents values for a MagneticAndGravityReferenceVectorsRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
...
bool parse(const std::string &in, vn::sensors::MagneticAndGravityReferenceVectorsRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a FilterMeasurementsVarianceParametersRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::FilterMeasurementsVarianceParametersRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a MagnetometerCompensationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::MagnetometerCompensationRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a FilterActiveTuningParametersRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::FilterActiveTuningParametersRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a AccelerationCompensationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::AccelerationCompensationRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a CommunicationProtocolControlRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::CommunicationProtocolControlRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a SynchronizationControlRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::SynchronizationControlRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a SynchronizationStatusRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::SynchronizationStatusRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a FilterBasicControlRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::FilterBasicControlRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a VpeBasicControlRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::VpeBasicControlRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a VpeMagnetometerBasicTuningRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::VpeMagnetometerBasicTuningRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a VpeMagnetometerAdvancedTuningRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::VpeMagnetometerAdvancedTuningRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a VpeAccelerometerBasicTuningRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::VpeAccelerometerBasicTuningRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a VpeAccelerometerAdvancedTuningRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::VpeAccelerometerAdvancedTuningRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a VpeGyroBasicTuningRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::VpeGyroBasicTuningRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a MagnetometerCalibrationControlRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::MagnetometerCalibrationControlRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a VelocityCompensationControlRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::VelocityCompensationControlRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a GpsConfigurationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::GpsConfigurationRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a InsBasicConfigurationRegisterVn200 struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::InsBasicConfigurationRegisterVn200 &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a InsBasicConfigurationRegisterVn300 struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::InsBasicConfigurationRegisterVn300 &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a InsAdvancedConfigurationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::InsAdvancedConfigurationRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a StartupFilterBiasEstimateRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::StartupFilterBiasEstimateRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a DeltaThetaAndDeltaVelocityConfigurationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::DeltaThetaAndDeltaVelocityConfigurationRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a ReferenceVectorConfigurationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::ReferenceVectorConfigurationRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a GyroCompensationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::GyroCompensationRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a ImuFilteringConfigurationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::ImuFilteringConfigurationRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a GpsCompassBaselineRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::GpsCompassBaselineRegister &reg, bool allowSloppy = true);

/// \brief Parses a string that represents values for a ImuRateConfigurationRegister struct.
/// \param[in] in The string to parse.
/// \param[out] reg The structure to hold the parsed value.
/// \param[in] allowSloppy Allows sloppy string representations of the values typical of user input.
/// \return Indicates if the parse was successful.
bool parse(const std::string &in, vn::sensors::ImuRateConfigurationRegister &reg, bool allowSloppy = true);
