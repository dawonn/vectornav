...
// Determines if nullptr is available.
#if (defined(_MSC_VER) && _MSC_VER <= 1600) || (__cplusplus < 201103L)
	#define VN_SUPPORTS_NULLPTR 0
#else
	#define VN_SUPPORTS_NULLPTR 1
#endif

// Determines if to_string is available.
#if (defined(_MSC_VER) && _MSC_VER <= 1600) || (__cplusplus < 201103L)
	#define VN_SUPPORTS_TO_STRING 0
#else
	#define VN_SUPPORTS_TO_STRING 1
#endif
