...
private:
	...
	static void parseBinaryPacketCommonGroup(protocol::uart::Packet& p, COMMONGROUP gf, std::vector<CompositeData*>& o);
	static void parseBinaryPacketTimeGroup(protocol::uart::Packet& p, TIMEGROUP gf, std::vector<CompositeData*>& o);
	static void parseBinaryPacketImuGroup(protocol::uart::Packet& p, IMUGROUP gf, std::vector<CompositeData*>& o);
	static void parseBinaryPacketGpsGroup(protocol::uart::Packet& p, GPSGROUP gf, std::vector<CompositeData*>& o);
	static void parseBinaryPacketAttitudeGroup(protocol::uart::Packet& p, ATTITUDEGROUP gf, std::vector<CompositeData*>& o);
	static void parseBinaryPacketInsGroup(protocol::uart::Packet& p, INSGROUP gf, std::vector<CompositeData*>& o);
