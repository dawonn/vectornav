...
#ifndef __cplusplus
typedef union vn_mat3f mat3f_t;
/*typedef union quatf quatf_t;*/
#endif
...
void vn_m3_init_fa(union vn_mat3f* m, const float* fa);
...
*/
void strFromMat3f(char* out, union vn_mat3f m);

/** \brief Negates a mat3f.
* \param[in] m Matrix to negate.
* \return Negated matrix. */
union vn_mat3f vnm_negative_mat3f(union vn_mat3f m);
