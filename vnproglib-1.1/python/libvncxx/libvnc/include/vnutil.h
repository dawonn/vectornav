...
enum VnError VnApi_getVersion(char *out, size_t outLength);
...
* \param[in] pos The current position to extract the value from.
* \return The extracted value. */
union vn_vec3f VnUtil_extractVec3f(const char* pos);
...
* \param[in] pos The current position to extract the value from.
* \return The extracted value. */
union vn_vec4f VnUtil_extractVec4f(const char* pos);
...
* \param[in] pos The current position to extract the value from.
* \return The extracted value. */
union vn_vec3d VnUtil_extractVec3d(const char* pos);
...
* \param[in] pos The current position to extract the value from.
* \return The extracted value. */
union vn_mat3f VnUtil_extractMat3f(const char* pos);
