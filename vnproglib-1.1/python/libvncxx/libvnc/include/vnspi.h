 ...
 * \param[in/out] size Number of bytes available in the buffer. Will contain
 *     on output the number of bytes in the command to send.
 ...
 * \param[out] responseSize The number of bytes to read during the SPI transaction
 *     to get this commands response.
 ...
 * \param[in] response Pointer to the buffer containing the response from
 *     the VectorNav sensor, including the leading 0x00 byte.
 ...
 * \param[in] buffer Caller provided buffer to place the generated command.
 * \param[in/out] size Number of bytes available in the buffer. Will contain on
 *     output the number of bytes in the command to send.
 * \param[in] desiredLength The total number of bytes to pad with 0x00 should
 *     the total constructed length of the command be less than the
 *     desiredLength. This is useful back-to-back command where the
 *     desiredLength will be the responseSize of the previous command sent.
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadAsyncDataOutputType(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadAsyncDataOutputFrequency(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadAttitudeQuaternion(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadQuaternionMagneticAccelerationAndAngularRates(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadMagneticMeasurements(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadAccelerationMeasurements(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadAngularRateMeasurements(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadMagneticAccelerationAndAngularRates(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadMagneticAndGravityReferenceVectors(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadMagnetometerCompensation(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadAccelerationCompensation(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadReferenceFrameRotation(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadYawPitchRollMagneticAccelerationAndAngularRates(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadCommunicationProtocolControl(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadSynchronizationControl(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadSynchronizationStatus(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadVpeMagnetometerBasicTuning(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadVpeAccelerometerBasicTuning(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadMagnetometerCalibrationControl(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadCalculatedMagnetometerCalibration(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadInsBasicConfiguration(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadStartupFilterBiasEstimate(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadDeltaThetaAndDeltaVelocity(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadImuFilteringConfiguration(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadGpsCompassBaseline(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadYawPitchRollTrueBodyAccelerationAndAngularRates(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genReadYawPitchRollTrueInertialAccelerationAndAngularRates(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize);
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genWriteAsyncDataOutputTypeWithOptions(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize,
 ...
 * \return Indicates any errors encountered. */
enum VnError
VnSpi_genWriteAsyncDataOutputFrequencyWithOptions(
    char *buffer,
    size_t *size,
    size_t desiredLength,
    size_t *responseSize,
