...
struct CompositeData::Impl
{
  ...
  enum PressureType { CDPRE_None, CDPRE_Normal };
  ...
  enum VelocityUncertaintyType { CDVEU_None, CDVEU_Gps, CDVEU_Gps2, CDVEU_Estimated };
  ...
  bool hasYawPitchRoll, hasQuaternion, hasDirectionCosineMatrix, hasMagnetic,
    hasMagneticUncompensated, hasMagneticNed, hasMagneticEcef, hasAcceleration,
    hasAccelerationLinearBody, hasAccelerationUncompensated, hasAccelerationLinearNed,
    hasAccelerationLinearEcef, hasAccelerationNed, hasAccelerationEcef, hasAngularRate,
    hasAngularRateUncompensated, hasTemperature, hasPressure, hasPositionGpsLla, hasPositionGps2Lla,
    hasPositionGpsEcef, hasPositionGps2Ecef, hasPositionEstimatedLla, hasPositionEstimatedEcef,
    hasVelocityGpsNed, hasVelocityGps2Ned, hasVelocityGpsEcef, hasVelocityGps2Ecef,
    hasVelocityEstimatedNed, hasVelocityEstimatedEcef, hasVelocityEstimatedBody, hasDeltaTime,
    hasDeltaTheta, hasDeltaVelocity, hasTimeStartup, hasTimeGps, hasTimeGps2, hasTow, hasWeek,
    hasGpsWeek, hasGps2Week, hasNumSats, hasNumSats2, hasTimeSyncIn, hasVpeStatus, hasInsStatus,
    hasSyncInCnt, hasSyncOutCnt, hasTimeStatus, hasTimeGpsPps, hasTimeGps2Pps, hasGpsTow,
    hasGps2Tow, hasTimeUtc, hasTimeUtc2, hasSensSat, hasFix, hasFix2, hasPositionUncertaintyGpsNed,
    hasPositionUncertaintyGps2Ned, hasPositionUncertaintyGpsEcef, hasPositionUncertaintyGps2Ecef,
    hasPositionUncertaintyEstimated, hasVelocityUncertaintyGps, hasVelocityUncertaintyGps2,
    hasVelocityUncertaintyEstimated, hasTimeUncertainty, hasTimeUncertainty2,
    hasAttitudeUncertainty, hasTimeInfo, hasTimeInfo2, hasDop, hasDop2;
  vec3f yawPitchRoll, magnetic, magneticUncompensated, magneticNed, magneticEcef, acceleration,
    accelerationLinearBody, accelerationUncompensated, accelerationLinearNed,
    accelerationLinearEcef, accelerationNed, accelerationEcef, angularRate,
    angularRateUncompensated, velocityGpsNed, velocityGps2Ned, velocityGpsEcef, velocityGps2Ecef,
    velocityEstimatedNed, velocityEstimatedEcef, velocityEstimatedBody, deltaTheta, deltaVelocity,
    positionUncertaintyGpsNed, positionUncertaintyGps2Ned, positionUncertaintyGpsEcef,
    positionUncertaintyGps2Ecef, attitudeUncertainty;
  vec3d positionGpsLla, positionGps2Lla, positionGpsEcef, positionGps2Ecef, positionEstimatedLla,
    positionEstimatedEcef;
  vec4f quaternion;
  mat3f directionConsineMatrix;
  float temperature, pressure, deltaTime, positionUncertaintyEstimated, velocityUncertaintyGps,
    velocityUncertaintyGps2, velocityUncertaintyEstimated;
...
CompositeData::CompositeData() : _i(new Impl) { _i->reset(); }

CompositeData::CompositeData(const CompositeData & cd) : _i(NULL) { (*this) = cd; }
...
bool CompositeData::hasYawPitchRoll() { return _i->hasYawPitchRoll; }

vec3f CompositeData::yawPitchRoll()
{
  if (!hasYawPitchRoll()) throw invalid_operation();

  return _i->yawPitchRoll;
}

bool CompositeData::hasQuaternion() { return _i->hasQuaternion; }

vec4f CompositeData::quaternion()
{
  if (!hasQuaternion()) throw invalid_operation();

  return _i->quaternion;
}

bool CompositeData::hasDirectionCosineMatrix() { return _i->hasDirectionCosineMatrix; }

mat3f CompositeData::directionCosineMatrix()
{
  if (!hasDirectionCosineMatrix()) throw invalid_operation();
...
bool CompositeData::hasMagnetic() { return _i->hasMagnetic; }

vec3f CompositeData::magnetic()
{
  if (!hasMagnetic()) throw invalid_operation();

  return _i->magnetic;
}

bool CompositeData::hasMagneticUncompensated() { return _i->hasMagneticUncompensated; }

vec3f CompositeData::magneticUncompensated()
{
  if (!hasMagneticUncompensated()) throw invalid_operation();

  return _i->magneticUncompensated;
}

bool CompositeData::hasMagneticNed() { return _i->hasMagneticNed; }

vec3f CompositeData::magneticNed()
{
  if (!hasMagneticNed()) throw invalid_operation();

  return _i->magneticNed;
}

bool CompositeData::hasMagneticEcef() { return _i->hasMagneticEcef; }

vec3f CompositeData::magneticEcef()
{
  if (!hasMagneticEcef()) throw invalid_operation();
...
bool CompositeData::hasAcceleration() { return _i->hasAcceleration; }

vec3f CompositeData::acceleration()
{
  if (!hasAcceleration()) throw invalid_operation();
...
{
  if (!hasAccelerationLinearBody()) throw invalid_operation();

  return _i->accelerationLinearBody;
}

bool CompositeData::hasAccelerationUncompensated() { return _i->hasAccelerationUncompensated; }

vec3f CompositeData::accelerationUncompensated()
{
  if (!hasAccelerationUncompensated()) throw invalid_operation();

  return _i->accelerationUncompensated;
}

bool CompositeData::hasAccelerationLinearNed() { return _i->hasAccelerationLinearNed; }

vec3f CompositeData::accelerationLinearNed()
{
  if (!hasAccelerationLinearNed()) throw invalid_operation();

  return _i->accelerationLinearNed;
}

bool CompositeData::hasAccelerationLinearEcef() { return _i->hasAccelerationLinearEcef; }

vec3f CompositeData::accelerationLinearEcef()
{
  if (!hasAccelerationLinearEcef()) throw invalid_operation();

  return _i->accelerationLinearEcef;
}

bool CompositeData::hasAccelerationNed() { return _i->hasAccelerationNed; }

vec3f CompositeData::accelerationNed()
{
  if (!hasAccelerationNed()) throw invalid_operation();

  return _i->accelerationNed;
}

bool CompositeData::hasAccelerationEcef() { return _i->hasAccelerationEcef; }

vec3f CompositeData::accelerationEcef()
{
  if (!hasAccelerationEcef()) throw invalid_operation();
...
bool CompositeData::hasAngularRate() { return _i->hasAngularRate; }

vec3f CompositeData::angularRate()
{
  if (!hasAngularRate()) throw invalid_operation();

  return _i->angularRate;
}

bool CompositeData::hasAngularRateUncompensated() { return _i->hasAngularRateUncompensated; }

vec3f CompositeData::angularRateUncompensated()
{
  if (!hasAngularRateUncompensated()) throw invalid_operation();
...
bool CompositeData::hasTemperature() { return _i->hasTemperature; }

float CompositeData::temperature()
{
  if (!hasTemperature()) throw invalid_operation();
...
bool CompositeData::hasPressure() { return _i->hasPressure; }

float CompositeData::pressure()
{
  if (!hasPressure()) throw invalid_operation();
...
bool CompositeData::hasPositionGpsLla() { return _i->hasPositionGpsLla; }

bool CompositeData::hasPositionGps2Lla() { return _i->hasPositionGps2Lla; }

vec3d CompositeData::positionGpsLla()
{
  if (!hasPositionGpsLla()) throw invalid_operation();
...
{
  if (!hasPositionGps2Lla()) throw invalid_operation();

  return _i->positionGps2Lla;
}

bool CompositeData::hasPositionGpsEcef() { return _i->hasPositionGpsEcef; }

bool CompositeData::hasPositionGps2Ecef() { return _i->hasPositionGps2Ecef; }

vec3d CompositeData::positionGpsEcef()
{
  if (!hasPositionGpsEcef()) throw invalid_operation();

  return _i->positionGpsEcef;
}
vec3d CompositeData::positionGps2Ecef()
{
  if (!hasPositionGps2Ecef()) throw invalid_operation();

  return _i->positionGps2Ecef;
}

bool CompositeData::hasPositionEstimatedLla() { return _i->hasPositionEstimatedLla; }

vec3d CompositeData::positionEstimatedLla()
{
  if (!hasPositionEstimatedLla()) throw invalid_operation();

  return _i->positionEstimatedLla;
}

bool CompositeData::hasPositionEstimatedEcef() { return _i->hasPositionEstimatedEcef; }

vec3d CompositeData::positionEstimatedEcef()
{
  if (!hasPositionEstimatedEcef()) throw invalid_operation();
...
bool CompositeData::hasVelocityGpsNed() { return _i->hasVelocityGpsNed; }

bool CompositeData::hasVelocityGps2Ned() { return _i->hasVelocityGps2Ned; }

vec3f CompositeData::velocityGpsNed()
{
  if (!hasVelocityGpsNed()) throw invalid_operation();
...
{
  if (!hasVelocityGps2Ned()) throw invalid_operation();
...
{
  if (!hasVelocityGpsEcef()) throw invalid_operation();
...
{
  if (!hasVelocityGps2Ecef()) throw invalid_operation();

  return _i->velocityGps2Ecef;
}

bool CompositeData::hasVelocityEstimatedNed() { return _i->hasVelocityEstimatedNed; }

vec3f CompositeData::velocityEstimatedNed()
{
  if (!hasVelocityEstimatedNed()) throw invalid_operation();

  return _i->velocityEstimatedNed;
}

bool CompositeData::hasVelocityEstimatedEcef() { return _i->hasVelocityEstimatedEcef; }

vec3f CompositeData::velocityEstimatedEcef()
{
  if (!hasVelocityEstimatedEcef()) throw invalid_operation();

  return _i->velocityEstimatedEcef;
}

bool CompositeData::hasVelocityEstimatedBody() { return _i->hasVelocityEstimatedBody; }

vec3f CompositeData::velocityEstimatedBody()
{
  if (!hasVelocityEstimatedBody()) throw invalid_operation();

  return _i->velocityEstimatedBody;
}

bool CompositeData::hasDeltaTime() { return _i->hasDeltaTime; }

float CompositeData::deltaTime()
{
  if (!hasDeltaTime()) throw invalid_operation();

  return _i->deltaTime;
}

bool CompositeData::hasDeltaTheta() { return _i->hasDeltaTheta; }

vec3f CompositeData::deltaTheta()
{
  if (!hasDeltaTheta()) throw invalid_operation();

  return _i->deltaTheta;
}

bool CompositeData::hasDeltaVelocity() { return _i->hasDeltaVelocity; }

vec3f CompositeData::deltaVelocity()
{
  if (!hasDeltaVelocity()) throw invalid_operation();

  return _i->deltaVelocity;
}

bool CompositeData::hasTimeStartup() { return _i->hasTimeStartup; }

uint64_t CompositeData::timeStartup()
{
  if (!hasTimeStartup()) throw invalid_operation();

  return _i->timeStartup;
}

bool CompositeData::hasTimeGps() { return _i->hasTimeGps; }

bool CompositeData::hasTimeGps2() { return _i->hasTimeGps2; }

uint64_t CompositeData::timeGps()
{
  if (!hasTimeGps()) throw invalid_operation();
...
{
  if (!hasTimeGps2()) throw invalid_operation();

  return _i->timeGps2;
}

bool CompositeData::hasTow() { return _i->hasTow; }

double CompositeData::tow()
{
  if (!hasTow()) throw invalid_operation();
...
{
  if (!hasWeek()) throw invalid_operation();

  return _i->week;
}

bool CompositeData::hasNumSats() { return _i->hasNumSats; }

uint8_t CompositeData::numSats()
{
  if (!hasNumSats()) throw invalid_operation();

  return _i->numSats;
}

bool CompositeData::hasTimeSyncIn() { return _i->hasTimeSyncIn; }

uint64_t CompositeData::timeSyncIn()
{
  if (!hasTimeSyncIn()) throw invalid_operation();

  return _i->timeSyncIn;
}

bool CompositeData::hasVpeStatus() { return _i->hasVpeStatus; }

VpeStatus CompositeData::vpeStatus()
{
  if (!hasVpeStatus()) throw invalid_operation();

  return _i->vpeStatus;
}

bool CompositeData::hasInsStatus() { return _i->hasInsStatus; }

InsStatus CompositeData::insStatus()
{
  if (!hasInsStatus()) throw invalid_operation();
...
{
  if (!hasSyncInCnt()) throw invalid_operation();

  return _i->syncInCnt;
}

bool CompositeData::hasSyncOutCnt() { return _i->hasSyncOutCnt; }

uint32_t CompositeData::syncOutCnt()
{
  if (!hasSyncOutCnt()) throw invalid_operation();

  return _i->syncOutCnt;
}

bool CompositeData::hasTimeStatus() { return _i->hasTimeStatus; }

uint8_t CompositeData::timeStatus()
{
  if (!hasTimeStatus()) throw invalid_operation();

  return _i->timeStatus;
}

bool CompositeData::hasTimeGpsPps() { return _i->hasTimeGpsPps; }

bool CompositeData::hasTimeGps2Pps() { return _i->hasTimeGps2Pps; }

uint64_t CompositeData::timeGpsPps()
{
  if (!hasTimeGpsPps()) throw invalid_operation();
...
{
  if (!hasTimeGps2Pps()) throw invalid_operation();

  return _i->timeGps2Pps;
}

bool CompositeData::hasGpsTow() { return _i->hasGpsTow; }

bool CompositeData::hasGps2Tow() { return _i->hasGps2Tow; }

uint64_t CompositeData::gpsTow()
{
  if (!hasGpsTow()) throw invalid_operation();
...
{
  if (!hasGps2Tow()) throw invalid_operation();

  return _i->gps2Tow;
}

bool CompositeData::hasTimeUtc() { return _i->hasTimeUtc; }

TimeUtc CompositeData::timeUtc()
{
  if (!hasTimeUtc()) throw invalid_operation();
...
{
  if (!hasSensSat()) throw invalid_operation();

  return _i->sensSat;
}

bool CompositeData::hasFix() { return _i->hasFix; }

bool CompositeData::hasFix2() { return _i->hasFix2; }

GpsFix CompositeData::fix()
{
  if (!hasFix()) throw invalid_operation();
...
{
  if (!hasFix2()) throw invalid_operation();
...
bool CompositeData::hasPositionUncertaintyGpsNed() { return _i->hasPositionUncertaintyGpsNed; }
...
{
  if (!hasPositionUncertaintyGpsNed()) throw invalid_operation();
...
{
  if (!hasPositionUncertaintyGps2Ned()) throw invalid_operation();

  return _i->positionUncertaintyGps2Ned;
}

bool CompositeData::hasPositionUncertaintyGpsEcef() { return _i->hasPositionUncertaintyGpsEcef; }

bool CompositeData::hasPositionUncertaintyGps2Ecef() { return _i->hasPositionUncertaintyGps2Ecef; }

vec3f CompositeData::positionUncertaintyGpsEcef()
{
  if (!hasPositionUncertaintyGpsEcef()) throw invalid_operation();
...
{
  if (!hasPositionUncertaintyGps2Ecef()) throw invalid_operation();
...
{
  if (!hasPositionUncertaintyEstimated()) throw invalid_operation();
...
bool CompositeData::hasVelocityUncertaintyGps() { return _i->hasVelocityUncertaintyGps; }

bool CompositeData::hasVelocityUncertaintyGps2() { return _i->hasVelocityUncertaintyGps2; }

float CompositeData::velocityUncertaintyGps()
{
  if (!hasVelocityUncertaintyGps()) throw invalid_operation();
...
{
  if (!hasVelocityUncertaintyGps2()) throw invalid_operation();
...
{
  if (!hasVelocityUncertaintyEstimated()) throw invalid_operation();

  return _i->velocityUncertaintyEstimated;
}

bool CompositeData::hasTimeUncertainty() { return _i->hasTimeUncertainty; }

uint32_t CompositeData::timeUncertainty()
{
  if (!hasTimeUncertainty()) throw invalid_operation();

  return _i->timeUncertainty;
}

bool CompositeData::hasAttitudeUncertainty() { return _i->hasAttitudeUncertainty; }

vec3f CompositeData::attitudeUncertainty()
{
  if (!hasAttitudeUncertainty()) throw invalid_operation();
...
{
  return _i->mostRecentlyUpdatedVelocityType != Impl::CDVEL_None &&
         _i->mostRecentlyUpdatedVelocityType !=
           Impl::
             CDVEL_EstimatedBody  // TODO: Don't have conversion formula from body frame to NED frame.
         &&
         _i->mostRecentlyUpdatedVelocityType !=
           Impl::
             CDVEL_EstimatedEcef  // TODO: Don't have conversion formula from ECEF frame to NED frame.
         &&
         _i->mostRecentlyUpdatedVelocityType !=
           Impl::CDVEL_GpsEcef  // TODO: Don't have conversion formula from ECEF frame to NED frame.
         &&
         _i->mostRecentlyUpdatedVelocityType !=
           Impl::
             CDVEL_Gps2Ecef;  // TODO: Don't have conversion formula from ECEF frame to NED frame.
}

float CompositeData::courseOverGround()
{
  if (!hasCourseOverGround()) throw invalid_operation();
...
{
  if (!hasSpeedOverGround()) throw invalid_operation();
...
bool CompositeData::hasTimeInfo() { return _i->hasTimeInfo; }

TimeInfo CompositeData::timeInfo()
{
  if (!hasTimeInfo()) throw invalid_operation();

  return _i->timeInfo;
}

bool CompositeData::hasDop() { return _i->hasDop; }

GnssDop CompositeData::dop()
{
  if (!hasDop()) throw invalid_operation();
...
void CompositeData::reset() { _i->reset(); }
...
void CompositeData::parseAscii(Packet & p, vector<CompositeData *> & o)
{
  switch (p.determineAsciiAsyncType()) {
    case VNYPR: {
      ...
      for (cditer i = o.begin(); i != o.end(); ++i) (*i)->_i->setYawPitchRoll(ypr);
    ...
    case VNQTN: {
      ...
      for (cditer i = o.begin(); i != o.end(); ++i) (*i)->_i->setQuaternion(quat);
    ...
    case VNMAG: {
      ...
      for (cditer i = o.begin(); i != o.end(); ++i) (*i)->_i->setMagnetic(mag);
    ...
    case VNACC: {
      ...
      for (cditer i = o.begin(); i != o.end(); ++i) (*i)->_i->setAcceleration(accel);
    ...
    case VNGYR: {
      ...
      for (cditer i = o.begin(); i != o.end(); ++i) (*i)->_i->setAngularRate(ar);
    ...
    case VNINS: {
      ...
      p.parseVNINS(
        &tow, &week, &status, &ypr, &position, &nedVel, &attUncertainty, &posUncertainty,
        &velUncertainty);
    ...
    case VNINE: {
      ...
      p.parseVNINE(
        &tow, &week, &status, &ypr, &position, &velocity, &attUncertainty, &posUncertainty,
        &velUncertainty);
...
void CompositeData::parseBinaryPacketCommonGroup(
  Packet & p, CommonGroup gf, vector<CompositeData *> & o)
{
  if (gf & COMMONGROUP_TIMESTARTUP) setValues(p.extractUint64(), o, &Impl::setTimeStartup);

  if (gf & COMMONGROUP_TIMEGPS) setValues(p.extractUint64(), o, &Impl::setTimeGps);

  if (gf & COMMONGROUP_TIMESYNCIN) setValues(p.extractUint64(), o, &Impl::setTimeSyncIn);

  if (gf & COMMONGROUP_YAWPITCHROLL) setValues(p.extractVec3f(), o, &Impl::setYawPitchRoll);

  if (gf & COMMONGROUP_QUATERNION) setValues(p.extractVec4f(), o, &Impl::setQuaternion);

  if (gf & COMMONGROUP_ANGULARRATE) setValues(p.extractVec3f(), o, &Impl::setAngularRate);

  if (gf & COMMONGROUP_POSITION) setValues(p.extractVec3d(), o, &Impl::setPositionEstimatedLla);

  if (gf & COMMONGROUP_VELOCITY) setValues(p.extractVec3f(), o, &Impl::setVelocityEstimatedNed);

  if (gf & COMMONGROUP_ACCEL) setValues(p.extractVec3f(), o, &Impl::setAcceleration);
  ...
  if (gf & COMMONGROUP_SYNCINCNT) setValues(p.extractUint32(), o, &Impl::setSyncInCnt);

  if (gf & COMMONGROUP_TIMEGPSPPS) setValues(p.extractUint64(), o, &Impl::setTimeGpsPps);
}

void CompositeData::parseBinaryPacketTimeGroup(
  Packet & p, TimeGroup gf, vector<CompositeData *> & o)
{
  if (gf & TIMEGROUP_TIMESTARTUP) setValues(p.extractUint64(), o, &Impl::setTimeStartup);

  if (gf & TIMEGROUP_TIMEGPS) setValues(p.extractUint64(), o, &Impl::setTimeGps);

  if (gf & TIMEGROUP_GPSTOW) setValues(((double)p.extractUint64() / 1000000000), o, &Impl::setTow);

  if (gf & TIMEGROUP_GPSWEEK) setValues(p.extractUint16(), o, &Impl::setWeek);

  if (gf & TIMEGROUP_TIMESYNCIN) setValues(p.extractUint64(), o, &Impl::setTimeSyncIn);

  if (gf & TIMEGROUP_TIMEGPSPPS) setValues(p.extractUint64(), o, &Impl::setTimeGpsPps);
  ...
  if (gf & TIMEGROUP_SYNCINCNT) setValues(p.extractUint32(), o, &Impl::setSyncInCnt);

  if (gf & TIMEGROUP_SYNCOUTCNT) setValues(p.extractUint32(), o, &Impl::setSyncOutCnt);

  if (gf & TIMEGROUP_TIMESTATUS) setValues(p.extractUint8(), o, &Impl::setTimeStatus);
}
...
void CompositeData::parseBinaryPacketImuGroup(Packet & p, ImuGroup gf, vector<CompositeData *> & o)
{
  ...
  if (gf & IMUGROUP_UNCOMPMAG) setValues(p.extractVec3f(), o, &Impl::setMagneticUncompensated);

  if (gf & IMUGROUP_UNCOMPACCEL)
    setValues(p.extractVec3f(), o, &Impl::setAccelerationUncompensated);

  if (gf & IMUGROUP_UNCOMPGYRO) setValues(p.extractVec3f(), o, &Impl::setAngularRateUncompensated);

  if (gf & IMUGROUP_TEMP) setValues(p.extractFloat(), o, &Impl::setTemperature);

  if (gf & IMUGROUP_PRES) setValues(p.extractFloat(), o, &Impl::setPressure);
  ...
  if (gf & IMUGROUP_DELTAVEL) setValues(p.extractVec3f(), o, &Impl::setDeltaVelocity);

  if (gf & IMUGROUP_MAG) setValues(p.extractVec3f(), o, &Impl::setMagnetic);

  if (gf & IMUGROUP_ACCEL) setValues(p.extractVec3f(), o, &Impl::setAcceleration);

  if (gf & IMUGROUP_ANGULARRATE) setValues(p.extractVec3f(), o, &Impl::setAngularRate);

  if (gf & IMUGROUP_SENSSAT) setValues(SensSat(p.extractUint16()), o, &Impl::setSensSat);
}
...
void CompositeData::parseBinaryPacketGpsGroup(Packet & p, GpsGroup gf, vector<CompositeData *> & o)
{
  ...
  if (gf & GPSGROUP_TOW) setValues(p.extractUint64(), o, &Impl::setGpsTow);

  if (gf & GPSGROUP_WEEK) setValues(p.extractUint16(), o, &Impl::setGpsWeek);

  if (gf & GPSGROUP_NUMSATS) setValues(p.extractUint8(), o, &Impl::setNumSats);

  if (gf & GPSGROUP_FIX) setValues(GpsFix(p.extractUint8()), o, &Impl::setFix);

  if (gf & GPSGROUP_POSLLA) setValues(p.extractVec3d(), o, &Impl::setPositionGpsLla);

  if (gf & GPSGROUP_POSECEF) setValues(p.extractVec3d(), o, &Impl::setPositionGpsEcef);

  if (gf & GPSGROUP_VELNED) setValues(p.extractVec3f(), o, &Impl::setVelocityGpsNed);

  if (gf & GPSGROUP_VELECEF) setValues(p.extractVec3f(), o, &Impl::setVelocityGpsEcef);

  if (gf & GPSGROUP_POSU) setValues(p.extractVec3f(), o, &Impl::setPositionUncertaintyGpsNed);

  if (gf & GPSGROUP_VELU) setValues(p.extractFloat(), o, &Impl::setVelocityUncertaintyGps);

  if (gf & GPSGROUP_TIMEU) setValues(p.extractUint32(), o, &Impl::setTimeUncertainty);
...
void CompositeData::parseBinaryPacketAttitudeGroup(
  Packet & p, AttitudeGroup gf, vector<CompositeData *> & o)
{
  if (gf & ATTITUDEGROUP_VPESTATUS) setValues(VpeStatus(p.extractUint16()), o, &Impl::setVpeStatus);

  if (gf & ATTITUDEGROUP_YAWPITCHROLL) setValues(p.extractVec3f(), o, &Impl::setYawPitchRoll);

  if (gf & ATTITUDEGROUP_QUATERNION) setValues(p.extractVec4f(), o, &Impl::setQuaternion);

  if (gf & ATTITUDEGROUP_DCM) setValues(p.extractMat3f(), o, &Impl::setDirectionConsineMatrix);

  if (gf & ATTITUDEGROUP_MAGNED) setValues(p.extractVec3f(), o, &Impl::setMagneticNed);

  if (gf & ATTITUDEGROUP_ACCELNED) setValues(p.extractVec3f(), o, &Impl::setAccelerationNed);
  ...
  if (gf & ATTITUDEGROUP_YPRU) setValues(p.extractVec3f(), o, &Impl::setAttitudeUncertainty);
}

void CompositeData::parseBinaryPacketInsGroup(Packet & p, InsGroup gf, vector<CompositeData *> & o)
{
  if (gf & INSGROUP_INSSTATUS) setValues(InsStatus(p.extractUint16()), o, &Impl::setInsStatus);

  if (gf & INSGROUP_POSLLA) setValues(p.extractVec3d(), o, &Impl::setPositionEstimatedLla);

  if (gf & INSGROUP_POSECEF) setValues(p.extractVec3d(), o, &Impl::setPositionEstimatedEcef);

  if (gf & INSGROUP_VELBODY) setValues(p.extractVec3f(), o, &Impl::setVelocityEstimatedBody);

  if (gf & INSGROUP_VELNED) setValues(p.extractVec3f(), o, &Impl::setVelocityEstimatedNed);

  if (gf & INSGROUP_VELECEF) setValues(p.extractVec3f(), o, &Impl::setVelocityEstimatedEcef);

  if (gf & INSGROUP_MAGECEF) setValues(p.extractVec3f(), o, &Impl::setMagneticEcef);

  if (gf & INSGROUP_ACCELECEF) setValues(p.extractVec3f(), o, &Impl::setAccelerationEcef);

  if (gf & INSGROUP_LINEARACCELECEF)
    setValues(p.extractVec3f(), o, &Impl::setAccelerationLinearEcef);

  if (gf & INSGROUP_POSU) setValues(p.extractFloat(), o, &Impl::setPositionUncertaintyEstimated);

  if (gf & INSGROUP_VELU) setValues(p.extractFloat(), o, &Impl::setVelocityUncertaintyEstimated);
}
...
void CompositeData::parseBinaryPacketGps2Group(Packet & p, GpsGroup gf, vector<CompositeData *> & o)
{
  ...
  if (gf & GPSGROUP_TOW) setValues(p.extractUint64(), o, &Impl::setGps2Tow);

  if (gf & GPSGROUP_WEEK) setValues(p.extractUint16(), o, &Impl::setGps2Week);

  if (gf & GPSGROUP_NUMSATS) setValues(p.extractUint8(), o, &Impl::setNumSats2);

  if (gf & GPSGROUP_FIX) setValues(GpsFix(p.extractUint8()), o, &Impl::setFix2);

  if (gf & GPSGROUP_POSLLA) setValues(p.extractVec3d(), o, &Impl::setPositionGps2Lla);

  if (gf & GPSGROUP_POSECEF) setValues(p.extractVec3d(), o, &Impl::setPositionGps2Ecef);

  if (gf & GPSGROUP_VELNED) setValues(p.extractVec3f(), o, &Impl::setVelocityGps2Ned);

  if (gf & GPSGROUP_VELECEF) setValues(p.extractVec3f(), o, &Impl::setVelocityGps2Ecef);

  if (gf & GPSGROUP_POSU) setValues(p.extractVec3f(), o, &Impl::setPositionUncertaintyGps2Ned);

  if (gf & GPSGROUP_VELU) setValues(p.extractFloat(), o, &Impl::setVelocityUncertaintyGps2);

  if (gf & GPSGROUP_TIMEU) setValues(p.extractUint32(), o, &Impl::setTimeUncertainty2);
