...
int ApiVersion::major() { return VNAPI_MAJOR; }

int ApiVersion::minor() { return VNAPI_MINOR; }

int ApiVersion::patch() { return VNAPI_PATCH; }

int ApiVersion::revision() { return VNAPI_REVISION; }
...
uint8_t to_uint8_from_hexstr(char const * str) { return toUint8FromHexStr(str); }
...
bool checkDllValidity(
  const std::string & dllName, const std::string & workingDirectory,
