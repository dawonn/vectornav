...
enum AsciiAsync {
  ...
  VNMAR =
    13,  ///< Asynchronous output type is Magnetic, Acceleration, and Angular Rate Measurements.
  VNYMR =
    14,  ///< Asynchronous output type is Yaw, Pitch, Roll, Magnetic, Acceleration, and Angular Rate Measurements.
#ifdef INTERNAL
...
#ifdef INTERNAL
  VNICM =
    18,  ///< Asynchronous output type is Yaw, Pitch, Roll, Inertial Magnetic/Acceleration, and Angular Rate Measurements.
#endif
