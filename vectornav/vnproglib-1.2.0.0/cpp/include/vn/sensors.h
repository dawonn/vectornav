...
public:
  ...
  typedef void (*RawDataReceivedHandler)(
    void * userData, const char * rawData, size_t length, size_t runningIndex);
  ...
  ///     the packet.
  typedef void (*PossiblePacketFoundHandler)(
    void * userData, protocol::uart::Packet & possiblePacket, size_t packetStartRunningIndex);
  ...
  /// \param[in] packetStartRunningIndex The running index of the start of
  ///     the packet.
  typedef void (*AsyncPacketReceivedHandler)(
    void * userData, protocol::uart::Packet & asyncPacket, size_t packetStartRunningIndex);
  ...
  /// \param[in] packetStartRunningIndex The running index of the start of
  ///     the packet.
  typedef void (*ErrorPacketReceivedHandler)(
    void * userData, protocol::uart::Packet & errorPacket, size_t packetStartRunningIndex);
  ...
  std::string send(
    std::string toSend, bool waitForReply = true,
    protocol::uart::ErrorDetectionMode errorDetectionMode =
      protocol::uart::ERRORDETECTIONMODE_CHECKSUM);
...
//Event<protocol::uart::Packet&, size_t, size_t> eventAsyncPacketRecieved;
  ...
  /// \param[in] port The port number to write to.
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeAsyncDataOutputType(
    protocol::uart::AsciiAsync ador, uint8_t port, bool waitForReply = true);
  ...
  void writeInsBasicConfigurationVn200(
    InsBasicConfigurationRegisterVn200 & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeInsBasicConfigurationVn200(
    protocol::uart::Scenario scenario, const uint8_t & ahrsAiding, bool waitForReply = true);
  ...
  void writeInsBasicConfigurationVn300(
    InsBasicConfigurationRegisterVn300 & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeInsBasicConfigurationVn300(
    protocol::uart::Scenario scenario, const uint8_t & ahrsAiding, const uint8_t & estBaseline,
  ...
  readQuaternionMagneticAccelerationAndAngularRates();
  ...
  void writeMagneticAndGravityReferenceVectors(
    MagneticAndGravityReferenceVectorsRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeMagneticAndGravityReferenceVectors(
    const vn::math::vec3f & magRef, const vn::math::vec3f & accRef, bool waitForReply = true);
  ...
  void writeFilterMeasurementsVarianceParameters(
    FilterMeasurementsVarianceParametersRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeFilterMeasurementsVarianceParameters(
    const float & angularWalkVariance, const vn::math::vec3f & angularRateVariance,
    const vn::math::vec3f & magneticVariance, const vn::math::vec3f & accelerationVariance,
    bool waitForReply = true);
  ...
  void writeMagnetometerCompensation(
    MagnetometerCompensationRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeMagnetometerCompensation(
    const vn::math::mat3f & c, const vn::math::vec3f & b, bool waitForReply = true);
  ...
  void writeFilterActiveTuningParameters(
    FilterActiveTuningParametersRegister & fields, bool waitForReply = true);
  ...
  void writeAccelerationCompensation(
    AccelerationCompensationRegister & fields, bool waitForReply = true);
  ...
  void writeCommunicationProtocolControl(
    CommunicationProtocolControlRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeCommunicationProtocolControl(
    protocol::uart::CountMode serialCount, protocol::uart::StatusMode serialStatus,
    protocol::uart::CountMode spiCount, protocol::uart::StatusMode spiStatus,
    protocol::uart::ChecksumMode serialChecksum, protocol::uart::ChecksumMode spiChecksum,
    protocol::uart::ErrorMode errorMode, bool waitForReply = true);
  ...
  void writeSynchronizationControl(
    SynchronizationControlRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeSynchronizationControl(
    protocol::uart::SyncInMode syncInMode, protocol::uart::SyncInEdge syncInEdge,
    const uint16_t & syncInSkipFactor, protocol::uart::SyncOutMode syncOutMode,
    protocol::uart::SyncOutPolarity syncOutPolarity, const uint16_t & syncOutSkipFactor,
    const uint32_t & syncOutPulseWidth, bool waitForReply = true);
  ...
  void writeFilterBasicControl(
    protocol::uart::MagneticMode magMode, protocol::uart::ExternalSensorMode extMagMode,
    protocol::uart::ExternalSensorMode extAccMode, protocol::uart::ExternalSensorMode extGyroMode,
    const vn::math::vec3f & gyroLimit, bool waitForReply = true);
  ...
  void writeHeaveConfiguration(
    const float & initialWavePeriod, const float & initialWaveAmplitude,
    const float & maxWavePeriod, const float & minWaveAmplitude,
    const float & delayedHeaveCutoffFreq, const float & heaveCutoffFreq,
    const float & heaveRateCutoffFreq, bool waitForReply = true);
  ...
  void writeVpeBasicControl(
    protocol::uart::VpeEnable enable, protocol::uart::HeadingMode headingMode,
    protocol::uart::VpeMode filteringMode, protocol::uart::VpeMode tuningMode,
    bool waitForReply = true);
  ...
  void writeVpeMagnetometerBasicTuning(
    VpeMagnetometerBasicTuningRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeVpeMagnetometerBasicTuning(
    const vn::math::vec3f & baseTuning, const vn::math::vec3f & adaptiveTuning,
    const vn::math::vec3f & adaptiveFiltering, bool waitForReply = true);
  ...
  void writeVpeMagnetometerAdvancedTuning(
    VpeMagnetometerAdvancedTuningRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeVpeMagnetometerAdvancedTuning(
    const vn::math::vec3f & minFiltering, const vn::math::vec3f & maxFiltering,
    const float & maxAdaptRate, const float & disturbanceWindow, const float & maxTuning,
    bool waitForReply = true);
  ...
  void writeVpeAccelerometerBasicTuning(
    VpeAccelerometerBasicTuningRegister & fields, bool waitForReply = true);
  ...
  void writeVpeAccelerometerAdvancedTuning(
    VpeAccelerometerAdvancedTuningRegister & fields, bool waitForReply = true);
  ...
  void writeVpeGyroBasicTuning(
    const vn::math::vec3f & angularWalkVariance, const vn::math::vec3f & baseTuning,
    const vn::math::vec3f & adaptiveTuning, bool waitForReply = true);
  ...
  void writeMagnetometerCalibrationControl(
    MagnetometerCalibrationControlRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeMagnetometerCalibrationControl(
    protocol::uart::HsiMode hsiMode, protocol::uart::HsiOutput hsiOutput,
    const uint8_t & convergeRate, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeVelocityCompensationMeasurement(
    const vn::math::vec3f & velocity, bool waitForReply = true);
  ...
  void writeVelocityCompensationControl(
    VelocityCompensationControlRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeVelocityCompensationControl(
    protocol::uart::VelocityCompensationMode mode, const float & velocityTuning,
    const float & rateTuning, bool waitForReply = true);
  ...
  void writeGpsConfiguration(
    protocol::uart::GpsMode mode, protocol::uart::PpsSource ppsSource, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeGpsConfiguration(
    protocol::uart::GpsMode mode, protocol::uart::PpsSource ppsSource, protocol::uart::GpsRate rate,
    protocol::uart::AntPower antPow, bool waitForReply = true);
  ...
  void writeInsAdvancedConfiguration(
    InsAdvancedConfigurationRegister & fields, bool waitForReply = true);
  ...
  void writeInsAdvancedConfiguration(
    ...
    const uint8_t & velBias, protocol::uart::FoamInit useFoam, const uint8_t & gpsCovType,
    const uint8_t & velCount, const float & velInit, const float & moveOrigin,
    const float & gpsTimeout, const float & deltaLimitPos, const float & deltaLimitVel,
    const float & minPosUncertainty, const float & minVelUncertainty, bool waitForReply = true);
  ...
  void writeStartupFilterBiasEstimate(
    StartupFilterBiasEstimateRegister & fields, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response from the sensor.
  void writeStartupFilterBiasEstimate(
    const vn::math::vec3f & gyroBias, const vn::math::vec3f & accelBias, const float & pressureBias,
    bool waitForReply = true);
  ...
  void writeDeltaThetaAndDeltaVelocityConfiguration(
    DeltaThetaAndDeltaVelocityConfigurationRegister & fields, bool waitForReply = true);
  ...
  void writeDeltaThetaAndDeltaVelocityConfiguration(
    ...
    protocol::uart::AccCompensationMode accelCompensation, bool waitForReply = true);
  ...
  void writeDeltaThetaAndDeltaVelocityConfiguration(
    ...
    protocol::uart::EarthRateCorrection earthRateCorrection, bool waitForReply = true);
  ...
  void writeReferenceVectorConfiguration(
    ReferenceVectorConfigurationRegister & fields, bool waitForReply = true);
  ...
  void writeReferenceVectorConfiguration(
    ...
    const float & year, const vn::math::vec3d & position, bool waitForReply = true);
  ...
  void writeImuFilteringConfiguration(
    ImuFilteringConfigurationRegister & fields, bool waitForReply = true);
  ...
  void writeImuFilteringConfiguration(
    ...
    const uint16_t & gyroWindowSize, const uint16_t & tempWindowSize,
    const uint16_t & presWindowSize, protocol::uart::FilterMode magFilterMode,
    protocol::uart::FilterMode accelFilterMode, protocol::uart::FilterMode gyroFilterMode,
    protocol::uart::FilterMode tempFilterMode, protocol::uart::FilterMode presFilterMode,
    bool waitForReply = true);
  ...
  void writeGpsCompassBaseline(
    const vn::math::vec3f & position, const vn::math::vec3f & uncertainty,
    bool waitForReply = true);
  ...
  void writeImuRateConfiguration(
    ...
    const float & filterMinRate, bool waitForReply = true);
  ...
  readYawPitchRollTrueBodyAccelerationAndAngularRates();
  ...
  readYawPitchRollTrueInertialAccelerationAndAngularRates();
