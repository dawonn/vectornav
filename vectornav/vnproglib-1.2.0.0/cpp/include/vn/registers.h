...
struct BinaryOutputRegister
{
  ...
  BinaryOutputRegister(
    protocol::uart::AsyncMode asyncModeIn, uint16_t rateDivisorIn,
    protocol::uart::CommonGroup commonFieldIn, protocol::uart::TimeGroup timeFieldIn,
    protocol::uart::ImuGroup imuFieldIn, protocol::uart::GpsGroup gpsFieldIn,
    protocol::uart::AttitudeGroup attitudeFieldIn, protocol::uart::InsGroup insFieldIn,
  ...
  BinaryOutputRegister(
    uint16_t asyncModeIn, uint16_t rateDivisorIn, uint16_t commonFieldIn, uint16_t timeFieldIn,
    uint16_t imuFieldIn, uint16_t gpsFieldIn, uint16_t attitudeFieldIn, uint16_t insFieldIn,
...
struct QuaternionMagneticAccelerationAndAngularRatesRegister
{
  ...
  QuaternionMagneticAccelerationAndAngularRatesRegister(
    vn::math::vec4f quatIn, vn::math::vec3f magIn, vn::math::vec3f accelIn, vn::math::vec3f gyroIn)
  : quat(quatIn), mag(magIn), accel(accelIn), gyro(gyroIn)
  {
  }
};
...
struct MagneticAccelerationAndAngularRatesRegister
{
  ...
  /// \param[in] gyroIn Value to initialize the gyro field with.
  MagneticAccelerationAndAngularRatesRegister(
    vn::math::vec3f magIn, vn::math::vec3f accelIn, vn::math::vec3f gyroIn)
  : mag(magIn), accel(accelIn), gyro(gyroIn)
  {
  }
};
...
struct MagneticAndGravityReferenceVectorsRegister
{
  ...
  : magRef(magRefIn), accRef(accRefIn)
  {
  }
};
...
struct FilterMeasurementsVarianceParametersRegister
{
  ...
  FilterMeasurementsVarianceParametersRegister(
    float angularWalkVarianceIn, vn::math::vec3f angularRateVarianceIn,
    vn::math::vec3f magneticVarianceIn, vn::math::vec3f accelerationVarianceIn)
...
struct MagnetometerCompensationRegister
{
  ...
  MagnetometerCompensationRegister(vn::math::mat3f cIn, vn::math::vec3f bIn) : c(cIn), b(bIn) {}
};
...
struct FilterActiveTuningParametersRegister
{
  ...
  FilterActiveTuningParametersRegister(
    float magneticDisturbanceGainIn, float accelerationDisturbanceGainIn,
    float magneticDisturbanceMemoryIn, float accelerationDisturbanceMemoryIn)
...
struct AccelerationCompensationRegister
{
  ...
  /// \param[in] cIn Value to initialize the c field with.
  /// \param[in] bIn Value to initialize the b field with.
  AccelerationCompensationRegister(vn::math::mat3f cIn, vn::math::vec3f bIn) : c(cIn), b(bIn) {}
};
...
struct YawPitchRollMagneticAccelerationAndAngularRatesRegister
{
  ...
  /// \param[in] gyroIn Value to initialize the gyro field with.
  YawPitchRollMagneticAccelerationAndAngularRatesRegister(
    vn::math::vec3f yawPitchRollIn, vn::math::vec3f magIn, vn::math::vec3f accelIn,
    vn::math::vec3f gyroIn)
  : yawPitchRoll(yawPitchRollIn), mag(magIn), accel(accelIn), gyro(gyroIn)
  {
  }
};
...
struct CommunicationProtocolControlRegister
{
  ...
  CommunicationProtocolControlRegister(
    protocol::uart::CountMode serialCountIn, protocol::uart::StatusMode serialStatusIn,
    protocol::uart::CountMode spiCountIn, protocol::uart::StatusMode spiStatusIn,
    protocol::uart::ChecksumMode serialChecksumIn, protocol::uart::ChecksumMode spiChecksumIn,
...
struct SynchronizationControlRegister
{
  ...
  SynchronizationControlRegister(
    protocol::uart::SyncInMode syncInModeIn, protocol::uart::SyncInEdge syncInEdgeIn,
    uint16_t syncInSkipFactorIn, protocol::uart::SyncOutMode syncOutModeIn,
    protocol::uart::SyncOutPolarity syncOutPolarityIn, uint16_t syncOutSkipFactorIn,
...
struct SynchronizationStatusRegister
{
  ...
  SynchronizationStatusRegister(
    uint32_t syncInCountIn, uint32_t syncInTimeIn, uint32_t syncOutCountIn)
  : syncInCount(syncInCountIn), syncInTime(syncInTimeIn), syncOutCount(syncOutCountIn)
  {
  }
};
...
struct FilterBasicControlRegister
{
  ...
  FilterBasicControlRegister(
    protocol::uart::MagneticMode magModeIn, protocol::uart::ExternalSensorMode extMagModeIn,
    protocol::uart::ExternalSensorMode extAccModeIn,
    protocol::uart::ExternalSensorMode extGyroModeIn, vn::math::vec3f gyroLimitIn)
  : magMode(magModeIn),
...
struct VpeBasicControlRegister
{
  ...
  VpeBasicControlRegister(
    protocol::uart::VpeEnable enableIn, protocol::uart::HeadingMode headingModeIn,
    protocol::uart::VpeMode filteringModeIn, protocol::uart::VpeMode tuningModeIn)
  : enable(enableIn),
...
struct HeaveConfigurationRegister
{
  ...
  HeaveConfigurationRegister(
    float initialWavePeriodIn, float initialWaveAmplitudeIn, float maxWavePeriodIn,
    float minWaveAmplitudeIn, float delayedHeaveCutoffFreqIn, float heaveCutoffFreqIn,
...
struct VpeMagnetometerBasicTuningRegister
{
  ...
  VpeMagnetometerBasicTuningRegister(
    vn::math::vec3f baseTuningIn, vn::math::vec3f adaptiveTuningIn,
...
struct VpeMagnetometerAdvancedTuningRegister
{
  ...
  VpeMagnetometerAdvancedTuningRegister(
    vn::math::vec3f minFilteringIn, vn::math::vec3f maxFilteringIn, float maxAdaptRateIn,
    float disturbanceWindowIn, float maxTuningIn)
...
struct VpeGyroBasicTuningRegister
{
  ...
  /// \param[in] adaptiveTuningIn Value to initialize the adaptiveTuning field with.
  VpeGyroBasicTuningRegister(
    vn::math::vec3f angularWalkVarianceIn, vn::math::vec3f baseTuningIn,
...
struct MagnetometerCalibrationControlRegister
{
  ...
  MagnetometerCalibrationControlRegister(
    protocol::uart::HsiMode hsiModeIn, protocol::uart::HsiOutput hsiOutputIn,
    uint8_t convergeRateIn)
  : hsiMode(hsiModeIn), hsiOutput(hsiOutputIn), convergeRate(convergeRateIn)
  {
  }
};
...
struct VelocityCompensationControlRegister
{
  ...
  VelocityCompensationControlRegister(
    protocol::uart::VelocityCompensationMode modeIn, float velocityTuningIn, float rateTuningIn)
  : mode(modeIn), velocityTuning(velocityTuningIn), rateTuning(rateTuningIn)
  {
  }
};
...
struct VelocityCompensationStatusRegister
{
  ...
  VelocityCompensationStatusRegister(
    float xIn, float xDotIn, vn::math::vec3f accelOffsetIn, vn::math::vec3f omegaIn)
  : x(xIn), xDot(xDotIn), accelOffset(accelOffsetIn), omega(omegaIn)
  {
  }
};
...
struct ImuMeasurementsRegister
{
  ...
  ImuMeasurementsRegister(
    vn::math::vec3f magIn, vn::math::vec3f accelIn, vn::math::vec3f gyroIn, float tempIn,
    float pressureIn)
  : mag(magIn), accel(accelIn), gyro(gyroIn), temp(tempIn), pressure(pressureIn)
  {
  }
};
...
struct GpsConfigurationRegister
{
  ...
  : rate(protocol::uart::GPSRATE_5HZ), antPow(protocol::uart::ANTPOWER_OFFRESV)
  {
  }
  ...
  GpsConfigurationRegister(
    protocol::uart::GpsMode modeIn, protocol::uart::PpsSource ppsSourceIn,
    protocol::uart::GpsRate rateIn, protocol::uart::AntPower antPowIn)
  : mode(modeIn), ppsSource(ppsSourceIn), rate(rateIn), antPow(antPowIn)
  {
  }
};
...
struct GpsSolutionLlaRegister
{
  ...
  GpsSolutionLlaRegister(
    double timeIn, uint16_t weekIn, protocol::uart::GpsFix gpsFixIn, uint8_t numSatsIn,
    vn::math::vec3d llaIn, vn::math::vec3f nedVelIn, vn::math::vec3f nedAccIn, float speedAccIn,
    float timeAccIn)
  : time(timeIn),
    week(weekIn),
    gpsFix(gpsFixIn),
...
struct GpsSolutionEcefRegister
{
  ...
  /// \param[in] timeAccIn Value to initialize the timeAcc field with.
  GpsSolutionEcefRegister(
    double towIn, uint16_t weekIn, protocol::uart::GpsFix gpsFixIn, uint8_t numSatsIn,
    vn::math::vec3d positionIn, vn::math::vec3f velocityIn, vn::math::vec3f posAccIn,
    float speedAccIn, float timeAccIn)
  : tow(towIn),
    week(weekIn),
    gpsFix(gpsFixIn),
    numSats(numSatsIn),
...
struct InsSolutionLlaRegister
{
  ...
  InsSolutionLlaRegister(
    double timeIn, uint16_t weekIn, uint16_t statusIn, vn::math::vec3f yawPitchRollIn,
    vn::math::vec3d positionIn, vn::math::vec3f nedVelIn, float attUncertaintyIn,
    float posUncertaintyIn, float velUncertaintyIn)
  : time(timeIn),
    week(weekIn),
    status(statusIn),
...
struct InsSolutionEcefRegister
{
  ...
  InsSolutionEcefRegister(
    double timeIn, uint16_t weekIn, uint16_t statusIn, vn::math::vec3f yawPitchRollIn,
    vn::math::vec3d positionIn, vn::math::vec3f velocityIn, float attUncertaintyIn,
    float posUncertaintyIn, float velUncertaintyIn)
  : time(timeIn),
    week(weekIn),
    status(statusIn),
...
struct InsBasicConfigurationRegisterVn200
{
  ...
  : scenario(scenarioIn), ahrsAiding(ahrsAidingIn)
  {
  }
};
...
struct InsBasicConfigurationRegisterVn300
{
  ...
  InsBasicConfigurationRegisterVn300(
    protocol::uart::Scenario scenarioIn, bool ahrsAidingIn, bool estBaselineIn)
  : scenario(scenarioIn), ahrsAiding(ahrsAidingIn), estBaseline(estBaselineIn)
  {
  }
};
...
struct InsAdvancedConfigurationRegister
{
  ...
  InsAdvancedConfigurationRegister(
    bool useMagIn, bool usePresIn, bool posAttIn, bool velAttIn, bool velBiasIn,
    protocol::uart::FoamInit useFoamIn, uint8_t gpsCovTypeIn, uint8_t velCountIn, float velInitIn,
    float moveOriginIn, float gpsTimeoutIn, float deltaLimitPosIn, float deltaLimitVelIn,
    float minPosUncertaintyIn, float minVelUncertaintyIn)
  : useMag(useMagIn),
    usePres(usePresIn),
    posAtt(posAttIn),
    velAtt(velAttIn),
...
struct InsStateLlaRegister
{
  ...
  InsStateLlaRegister(
    vn::math::vec3f yawPitchRollIn, vn::math::vec3d positionIn, vn::math::vec3f velocityIn,
    vn::math::vec3f accelIn, vn::math::vec3f angularRateIn)
  : yawPitchRoll(yawPitchRollIn),
    position(positionIn),
    velocity(velocityIn),
    accel(accelIn),
...
struct StartupFilterBiasEstimateRegister
{
  ...
  StartupFilterBiasEstimateRegister(
    vn::math::vec3f gyroBiasIn, vn::math::vec3f accelBiasIn, float pressureBiasIn)
  : gyroBias(gyroBiasIn), accelBias(accelBiasIn), pressureBias(pressureBiasIn)
  {
  }
};
...
struct DeltaThetaAndDeltaVelocityRegister
{
  ...
  DeltaThetaAndDeltaVelocityRegister(
    float deltaTimeIn, vn::math::vec3f deltaThetaIn, vn::math::vec3f deltaVelocityIn)
  : deltaTime(deltaTimeIn), deltaTheta(deltaThetaIn), deltaVelocity(deltaVelocityIn)
  {
  }
};
...
struct ReferenceVectorConfigurationRegister
{
  ...
  /// \param[in] positionIn Value to initialize the position field with.
  ReferenceVectorConfigurationRegister(
    bool useMagModelIn, bool useGravityModelIn, uint32_t recalcThresholdIn, float yearIn,
...
struct GyroCompensationRegister
{
  ...
  /// \param[in] cIn Value to initialize the c field with.
  /// \param[in] bIn Value to initialize the b field with.
  GyroCompensationRegister(vn::math::mat3f cIn, vn::math::vec3f bIn) : c(cIn), b(bIn) {}
};
...
struct ImuFilteringConfigurationRegister
{
  ...
  ImuFilteringConfigurationRegister(
    uint16_t magWindowSizeIn, uint16_t accelWindowSizeIn, uint16_t gyroWindowSizeIn,
    uint16_t tempWindowSizeIn, uint16_t presWindowSizeIn,
    protocol::uart::FilterMode magFilterModeIn, protocol::uart::FilterMode accelFilterModeIn,
    protocol::uart::FilterMode gyroFilterModeIn, protocol::uart::FilterMode tempFilterModeIn,
...
struct GpsCompassBaselineRegister
{
  ...
  : position(positionIn), uncertainty(uncertaintyIn)
  {
  }
};
...
struct GpsCompassEstimatedBaselineRegister
{
  ...
  /// \param[in] uncertaintyIn Value to initialize the uncertainty field with.
  GpsCompassEstimatedBaselineRegister(
    bool estBaselineUsedIn, uint16_t numMeasIn, vn::math::vec3f positionIn,
...
struct ImuRateConfigurationRegister
{
  ...
  ImuRateConfigurationRegister(
    uint16_t imuRateIn, uint16_t navDivisorIn, float filterTargetRateIn, float filterMinRateIn)
  : imuRate(imuRateIn),
...
struct YawPitchRollTrueBodyAccelerationAndAngularRatesRegister
{
  ...
  /// \param[in] gyroIn Value to initialize the gyro field with.
  YawPitchRollTrueBodyAccelerationAndAngularRatesRegister(
    vn::math::vec3f yawPitchRollIn, vn::math::vec3f bodyAccelIn, vn::math::vec3f gyroIn)
  : yawPitchRoll(yawPitchRollIn), bodyAccel(bodyAccelIn), gyro(gyroIn)
  {
  }
};
...
struct YawPitchRollTrueInertialAccelerationAndAngularRatesRegister
{
  ...
  /// \param[in] gyroIn Value to initialize the gyro field with.
  YawPitchRollTrueInertialAccelerationAndAngularRatesRegister(
    vn::math::vec3f yawPitchRollIn, vn::math::vec3f inertialAccelIn, vn::math::vec3f gyroIn)
  : yawPitchRoll(yawPitchRollIn), inertialAccel(inertialAccelIn), gyro(gyroIn)
  {
  }
};
