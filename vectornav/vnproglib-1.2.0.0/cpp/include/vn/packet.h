...
struct vn_proglib_DLLEXPORT Packet
{
  ...
  static size_t finalizeCommand(
    ErrorDetectionMode errorDetectionMode, char * packet, size_t length);
  ...
  static size_t genReadBinaryOutput1(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadBinaryOutput2(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadBinaryOutput3(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteBinaryOutput1(
  ...
  /// \param[in] gps2Field The register's Group 7 (GPS2) field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteBinaryOutput2(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, uint16_t asyncMode,
    uint16_t rateDivisor, uint16_t commonField, uint16_t timeField, uint16_t imuField,
    uint16_t gpsField, uint16_t attitudeField, uint16_t insField, uint16_t gps2Field);
  ...
  /// \param[in] gps2Field The register's Group 7 (GPS2) field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteBinaryOutput3(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, uint16_t asyncMode,
    uint16_t rateDivisor, uint16_t commonField, uint16_t timeField, uint16_t imuField,
    uint16_t gpsField, uint16_t attitudeField, uint16_t insField, uint16_t gps2Field);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genKnownMagneticDisturbance(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size,
  ...
  /// \return The total number bytes in the generated command.
  static size_t genKnownAccelerationDisturbance(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size,
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genRestoreFactorySettings(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genFirmwareUpdate(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genReadSerialBaudRate(
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteSerialBaudRate(
  ...
  /// \param[in] port The port to read from.
  /// \return The total number bytes in the generated command.
  static size_t genReadAsyncDataOutputType(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, uint8_t port);
  ...
  /// \param[in] port The port to write to.
  /// \return The total number bytes in the generated command.
  static size_t genWriteAsyncDataOutputType(
  ...
  /// \param[in] port The port to read from.
  /// \return The total number bytes in the generated command.
  static size_t genReadAsyncDataOutputFrequency(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, uint8_t port);
  ...
  /// \param[in] port The port to write to.
  /// \return The total number bytes in the generated command.
  static size_t genWriteAsyncDataOutputFrequency(
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteFirmwareUpdateRecord(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, std::string record);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteUserTag(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, std::string tag);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadModelNumber(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadHardwareRevision(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadSerialNumber(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadFirmwareVersion(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadYawPitchRoll(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadAttitudeQuaternion(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadQuaternionMagneticAccelerationAndAngularRates(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadMagneticMeasurements(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadAccelerationMeasurements(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadAngularRateMeasurements(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadMagneticAccelerationAndAngularRates(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadMagneticAndGravityReferenceVectors(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteMagneticAndGravityReferenceVectors(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f magRef,
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadFilterMeasurementsVarianceParameters(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteFilterMeasurementsVarianceParameters(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, float angularWalkVariance,
    vn::math::vec3f angularRateVariance, vn::math::vec3f magneticVariance,
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadMagnetometerCompensation(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteMagnetometerCompensation(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::mat3f c,
    vn::math::vec3f b);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadFilterActiveTuningParameters(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteFilterActiveTuningParameters(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size,
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadAccelerationCompensation(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] b The register's B field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteAccelerationCompensation(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::mat3f c,
    vn::math::vec3f b);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadReferenceFrameRotation(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] c The register's C field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteReferenceFrameRotation(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::mat3f c);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadYawPitchRollMagneticAccelerationAndAngularRates(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadCommunicationProtocolControl(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteCommunicationProtocolControl(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadSynchronizationControl(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteSynchronizationControl(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadSynchronizationStatus(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteSynchronizationStatus(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadFilterBasicControl(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteFilterBasicControl(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, uint8_t magMode,
    uint8_t extMagMode, uint8_t extAccMode, uint8_t extGyroMode, vn::math::vec3f gyroLimit);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadHeaveConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteHeaveConfiguration(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVpeBasicControl(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteVpeBasicControl(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVpeMagnetometerBasicTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteVpeMagnetometerBasicTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f baseTuning,
    vn::math::vec3f adaptiveTuning, vn::math::vec3f adaptiveFiltering);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVpeMagnetometerAdvancedTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteVpeMagnetometerAdvancedTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f minFiltering,
    vn::math::vec3f maxFiltering, float maxAdaptRate, float disturbanceWindow, float maxTuning);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVpeAccelerometerBasicTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] adaptiveFiltering The register's AdaptiveFiltering field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteVpeAccelerometerBasicTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f baseTuning,
    vn::math::vec3f adaptiveTuning, vn::math::vec3f adaptiveFiltering);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVpeAccelerometerAdvancedTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] maxTuning The register's MaxTuning field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteVpeAccelerometerAdvancedTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f minFiltering,
    vn::math::vec3f maxFiltering, float maxAdaptRate, float disturbanceWindow, float maxTuning);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVpeGyroBasicTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] adaptiveTuning The register's AdaptiveTuning field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteVpeGyroBasicTuning(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size,
    vn::math::vec3f angularWalkVariance, vn::math::vec3f baseTuning,
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadFilterStartupGyroBias(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteFilterStartupGyroBias(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f bias);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadMagnetometerCalibrationControl(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteMagnetometerCalibrationControl(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadCalculatedMagnetometerCalibration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadIndoorHeadingModeControl(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteIndoorHeadingModeControl(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVelocityCompensationMeasurement(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteVelocityCompensationMeasurement(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f velocity);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVelocityCompensationControl(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteVelocityCompensationControl(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadVelocityCompensationStatus(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadImuMeasurements(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadGpsConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteGpsConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, uint8_t mode,
    uint8_t ppsSource);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadGpsAntennaOffset(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteGpsAntennaOffset(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f position);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadGpsSolutionLla(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadGpsSolutionEcef(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadInsSolutionLla(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadInsSolutionEcef(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadInsBasicConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteInsBasicConfiguration(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadInsAdvancedConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadInsStateLla(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadInsStateEcef(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadStartupFilterBiasEstimate(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteStartupFilterBiasEstimate(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f gyroBias,
    vn::math::vec3f accelBias, float pressureBias);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadDeltaThetaAndDeltaVelocity(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadDeltaThetaAndDeltaVelocityConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteDeltaThetaAndDeltaVelocityConfiguration(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadReferenceVectorConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] position The register's Position field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteReferenceVectorConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, uint8_t useMagModel,
    uint8_t useGravityModel, uint32_t recalcThreshold, float year, vn::math::vec3d position);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadGyroCompensation(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] b The register's B field.
  /// \return The total number bytes in the generated command.
  static size_t genWriteGyroCompensation(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::mat3f c,
    vn::math::vec3f b);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadImuFilteringConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteImuFilteringConfiguration(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadGpsCompassBaseline(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteGpsCompassBaseline(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size, vn::math::vec3f position,
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadGpsCompassEstimatedBaseline(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadImuRateConfiguration(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \return The total number bytes in the generated command.
  static size_t genWriteImuRateConfiguration(
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadYawPitchRollTrueBodyAccelerationAndAngularRates(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[in] size Number of bytes available in the provided buffer.
  /// \return The total number bytes in the generated command.
  static size_t genReadYawPitchRollTrueInertialAccelerationAndAngularRates(
    ErrorDetectionMode errorDetectionMode, char * buffer, size_t size);
  ...
  /// \param[out] angularRate The angular rate values in the packet.
  void parseVNQMR(
    vn::math::vec4f * quaternion, vn::math::vec3f * magnetic, vn::math::vec3f * acceleration,
  ...
  /// \param[out] angularRate The angular rate values in the packet.
  void parseVNMAR(
    vn::math::vec3f * magnetic, vn::math::vec3f * acceleration, vn::math::vec3f * angularRate);
  ...
  /// \param[out] angularRate The angular rate values in the packet.
  void parseVNYMR(
    vn::math::vec3f * yawPitchRoll, vn::math::vec3f * magnetic, vn::math::vec3f * acceleration,
    vn::math::vec3f * angularRate);
  ...
  void parseVNYCM(
    math::vec3f * yawPitchRoll, math::vec3f * magnetic, math::vec3f * acceleration,
    math::vec3f * angularRate, float * temperature);
  ...
  /// \param[out] angularRate The angular rate values in the packet.
  void parseVNYBA(
    vn::math::vec3f * yawPitchRoll, vn::math::vec3f * accelerationBody,
    vn::math::vec3f * angularRate);
  ...
  /// \param[out] angularRate The angular rate values in the packet.
  void parseVNYIA(
    vn::math::vec3f * yawPitchRoll, vn::math::vec3f * accelerationInertial,
    vn::math::vec3f * angularRate);
  ...
  /// \param[out] angularRate The angular rate values in the packet.
  void parseVNICM(
    math::vec3f * yawPitchRoll, math::vec3f * magnetic, math::vec3f * accelerationInertial,
  ...
  void parseVNIMU(
    vn::math::vec3f * magneticUncompensated, vn::math::vec3f * accelerationUncompensated,
    vn::math::vec3f * angularRateUncompensated, float * temperature, float * pressure);
  ...
  void parseVNGPS(
    double * time, uint16_t * week, uint8_t * gpsFix, uint8_t * numSats, vn::math::vec3d * lla,
    vn::math::vec3f * nedVel, vn::math::vec3f * nedAcc, float * speedAcc, float * timeAcc);
  ...
  void parseVNINS(
    double * time, uint16_t * week, uint16_t * status, vn::math::vec3f * yawPitchRoll,
    vn::math::vec3d * lla, vn::math::vec3f * nedVel, float * attUncertainty, float * posUncertainty,
  ...
  /// \param[out] velUncertainty The velocity uncertainty value in the packet.
  void parseVNINE(
    double * time, uint16_t * week, uint16_t * status, vn::math::vec3f * ypr,
    vn::math::vec3d * position, vn::math::vec3f * velocity, float * attUncertainty,
    float * posUncertainty, float * velUncertainty);
  ...
  /// \param[out] angularRate The angular rate values in the packet.
  void parseVNISL(
    vn::math::vec3f * ypr, vn::math::vec3d * lla, vn::math::vec3f * velocity,
    vn::math::vec3f * acceleration, vn::math::vec3f * angularRate);
  ...
  /// \param[out] angularRate The angular rate values in the packet.
  void parseVNISE(
    vn::math::vec3f * ypr, vn::math::vec3d * position, vn::math::vec3f * velocity,
    vn::math::vec3f * acceleration, vn::math::vec3f * angularRate);
  ...
  void parseVNRAW(
    math::vec3f * magneticVoltage, math::vec3f * accelerationVoltage,
    math::vec3f * angularRateVoltage, float * temperatureVoltage);
  ...
  /// \param[out] temperature The temperature value in the packet.
  void parseVNCMV(
    math::vec3f * magneticUncompensated, math::vec3f * accelerationUncompensated,
    math::vec3f * angularRateUncompensated, float * temperature);
  ...
  /// \param[out] timeAcc The TimeAcc value in the packet.
  void parseVNGPE(
    double * tow, uint16_t * week, uint8_t * gpsFix, uint8_t * numSats, vn::math::vec3d * position,
    vn::math::vec3f * velocity, vn::math::vec3f * posAcc, float * speedAcc, float * timeAcc);
  ...
  void parseQuaternionMagneticAccelerationAndAngularRates(
    vn::math::vec4f * quat, vn::math::vec3f * mag, vn::math::vec3f * accel, vn::math::vec3f * gyro);
  ...
  /// \param[out] accel The register's Accel field.
  /// \param[out] gyro The register's Gyro field.
  void parseMagneticAccelerationAndAngularRates(
    vn::math::vec3f * mag, vn::math::vec3f * accel, vn::math::vec3f * gyro);
  ...
  void parseFilterMeasurementsVarianceParameters(
    float * angularWalkVariance, vn::math::vec3f * angularRateVariance,
    vn::math::vec3f * magneticVariance, vn::math::vec3f * accelerationVariance);
  ...
  void parseFilterActiveTuningParameters(
    float * magneticDisturbanceGain, float * accelerationDisturbanceGain,
    float * magneticDisturbanceMemory, float * accelerationDisturbanceMemory);
  ...
  /// \param[out] accel The register's Accel field.
  /// \param[out] gyro The register's Gyro field.
  void parseYawPitchRollMagneticAccelerationAndAngularRates(
    vn::math::vec3f * yawPitchRoll, vn::math::vec3f * mag, vn::math::vec3f * accel,
    vn::math::vec3f * gyro);
  ...
  void parseCommunicationProtocolControl(
  ...
  void parseSynchronizationControl(
  ...
  void parseSynchronizationStatus(
  ...
  void parseVpeMagnetometerBasicTuning(
    vn::math::vec3f * baseTuning, vn::math::vec3f * adaptiveTuning,
  ...
  void parseVpeMagnetometerAdvancedTuning(
    vn::math::vec3f * minFiltering, vn::math::vec3f * maxFiltering, float * maxAdaptRate,
    float * disturbanceWindow, float * maxTuning);
  ...
  /// \param[out] adaptiveTuning The register's AdaptiveTuning field.
  /// \param[out] adaptiveFiltering The register's AdaptiveFiltering field.
  void parseVpeAccelerometerBasicTuning(
    vn::math::vec3f * baseTuning, vn::math::vec3f * adaptiveTuning,
    vn::math::vec3f * adaptiveFiltering);
  ...
  /// \param[out] disturbanceWindow The register's DisturbanceWindow field.
  /// \param[out] maxTuning The register's MaxTuning field.
  void parseVpeAccelerometerAdvancedTuning(
    vn::math::vec3f * minFiltering, vn::math::vec3f * maxFiltering, float * maxAdaptRate,
    float * disturbanceWindow, float * maxTuning);
  ...
  void parseMagnetometerCalibrationControl(
  ...
  void parseVelocityCompensationStatus(
    float * x, float * xDot, vn::math::vec3f * accelOffset, vn::math::vec3f * omega);
  ...
  void parseImuMeasurements(
    vn::math::vec3f * mag, vn::math::vec3f * accel, vn::math::vec3f * gyro, float * temp,
    float * pressure);
  ...
  void parseInsSolutionLla(
    double * time, uint16_t * week, uint16_t * status, vn::math::vec3f * yawPitchRoll,
    vn::math::vec3d * position, vn::math::vec3f * nedVel, float * attUncertainty,
    float * posUncertainty, float * velUncertainty);
  ...
  void parseInsAdvancedConfiguration(
    uint8_t * useMag, uint8_t * usePres, uint8_t * posAtt, uint8_t * velAtt, uint8_t * velBias,
    uint8_t * useFoam, uint8_t * gpsCovType, uint8_t * velCount, float * velInit,
    float * moveOrigin, float * gpsTimeout, float * deltaLimitPos, float * deltaLimitVel,
    float * minPosUncertainty, float * minVelUncertainty);
  ...
  void parseInsStateLla(
    vn::math::vec3f * yawPitchRoll, vn::math::vec3d * position, vn::math::vec3f * velocity,
    vn::math::vec3f * accel, vn::math::vec3f * angularRate);
  ...
  void parseStartupFilterBiasEstimate(
    vn::math::vec3f * gyroBias, vn::math::vec3f * accelBias, float * pressureBias);
  ...
  void parseDeltaThetaAndDeltaVelocity(
    float * deltaTime, vn::math::vec3f * deltaTheta, vn::math::vec3f * deltaVelocity);
  ...
  void parseDeltaThetaAndDeltaVelocityConfiguration(
  ...
  /// \param[out] position The register's Position field.
  void parseReferenceVectorConfiguration(
  ...
  /// \param[out] position The register's Position field.
  /// \param[out] uncertainty The register's Uncertainty field.
  void parseGpsCompassEstimatedBaseline(
    uint8_t * estBaselineUsed, uint16_t * numMeas, vn::math::vec3f * position,
    vn::math::vec3f * uncertainty);
  ...
  void parseImuRateConfiguration(
  ...
  /// \param[out] gyro The register's Gyro field.
  void parseYawPitchRollTrueBodyAccelerationAndAngularRates(
    vn::math::vec3f * yawPitchRoll, vn::math::vec3f * bodyAccel, vn::math::vec3f * gyro);
  ...
  /// \param[out] gyro The register's Gyro field.
  void parseYawPitchRollTrueInertialAccelerationAndAngularRates(
    vn::math::vec3f * yawPitchRoll, vn::math::vec3f * inertialAccel, vn::math::vec3f * gyro);
